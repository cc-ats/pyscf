...
def z_oscillator_strength(tdobj, e=None, xy=None, order=0):
...
ax1.stem(27.2116*lrtd.e, z_oscillator_strength(lrtd), linefmt='grey', markerfmt=None, basefmt=" ", use_line_collection=True, label="lr-tddft")

for field_strength in [1e-2, 1e-3, 1e-4]:
    ...
    mw, sigma = build_absorption_spectrum(0.2, time[:4000], dip[4001:,:], damp_expo=50.0)
...
left_axis.set_ylim(-0.008,0.008)
